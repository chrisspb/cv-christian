...
const CODE_SNIPPET = `<span class="c-kw">const</span> <span class="c-fn">developer</span> <span class="c-op">=</span> {
  <span class="c-key">name</span><span class="c-op">:</span>        <span class="c-str">"Christian"</span>,
  <span class="c-key">role</span><span class="c-op">:</span>        <span class="c-str">"Lead Front-End"</span>,
  <span class="c-key">xp</span><span class="c-op">:</span>          <span class="c-str">"8+ ans"</span>,
  <span class="c-key">stack</span><span class="c-op">:</span>       [
    <span class="c-str">"Vue 3"</span>, <span class="c-str">"React"</span>,
    <span class="c-str">"TypeScript"</span>,
  ],
  <span class="c-key">superpower</span><span class="c-op">:</span>  <span class="c-str">"AI × Vibe Coding"</span>,
  <span class="c-key">available</span><span class="c-op">:</span>   <span class="c-bool">true</span>,
    ...
    <>
      ...
      <main>
        ...
        <section id="education">
          ...
          <div className="edu-grid" style={{marginBottom:'2.5rem'}}>
            {EDUCATION.map((edu) => (
